...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    name: "Truck Bed Mats",
    count: 133,
    // Cycle 14AP-fix3 (owner): distinct asset from MOLLE PANELS — earlier
    // both tiles pointed at the same JPG, customer saw the same image
    // twice in the grid. New asset shows an actual rubber bed mat
    // fitted in a truck bed, generated by the regen script.
    image: "/images/categories/TRUCK BED MAT.jpg",
  },
  {
  ...
  {
    // Cycle 14AP-fix3 (owner): renamed from "Under Seat Storage" to
    // "Accessories" — broader bucket for the small-item / organizer /
    // mount / hardware family. Slug kept for URL stability so any
    // existing inbound links / bookmarks still resolve.
