...
const I = {
  ...
  mail:      (p) => <Icon {...p} d="M4 4h16a2 2 0 012 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zM22 6l-10 7L2 6" />,
  clock:     (p) => <Icon {...p} d="M12 22a10 10 0 100-20 10 10 0 000 20zM12 6v6l4 2" />,
  box:       (p) => <Icon {...p} d="M21 8l-9-5-9 5 9 5 9-5zM3 8v8l9 5 9-5V8M12 13v8" />,
  bolt:      (p) => <Icon {...p} d="M13 2L3 14h9l-1 8 10-12h-9z" />,
  cc:        (p) => <Icon {...p} d="M2 7h20v12H2zM2 11h20" />,
};
