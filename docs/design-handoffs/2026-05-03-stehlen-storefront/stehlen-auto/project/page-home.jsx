      ...
      <section style={{
        ...
        <img
          ...
          style={{
            ...
            objectFit: 'cover',
            objectPosition: mobile ? 'center center' : 'center center',
          }}
        />
        {/* Gradient mask — darken left third only, fade quickly so image fills frame */}
        <div aria-hidden="true" style={{
          position: 'absolute', inset: 0,
          background: mobile
            ? 'linear-gradient(180deg, rgba(10,10,10,0.55) 0%, rgba(10,10,10,0.92) 60%, rgba(10,10,10,0.97) 100%)'
            : 'linear-gradient(90deg, rgba(10,10,10,0.85) 0%, rgba(10,10,10,0.7) 20%, rgba(10,10,10,0.3) 40%, rgba(10,10,10,0) 55%)',
        }} />
        ...
        <div className="container" style={{
          ...
          <div style={{ maxWidth: mobile ? '100%' : 480, width: mobile ? '100%' : '40%' }}>
